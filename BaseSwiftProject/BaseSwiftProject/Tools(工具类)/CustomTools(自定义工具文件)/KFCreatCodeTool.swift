//
//  KFCreatCodeTool.swift
//  SmallSheep
//
//  Created by KF001 on 2018/10/24.
//  Copyright © 2018年 KFZS. All rights reserved.
//

import UIKit

class KFCreatCodeTool: NSObject {
    // MARK: - 传入url和头像image，得到二维码
    class func creatQRCodeImage(_ text: String, image: UIImage? = nil) -> UIImage{
        //创建滤镜
